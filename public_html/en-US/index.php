        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="page-scroll" href="#portfolio">Experience</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a class="page-scroll" href="http://tienda.softcaribe.com.mx">Store</a>
                    </li>
                    <li style="padding-left:15px;">
                      <a class="nav-lang" href="../index.php">ES</a><span class="nav-lang">&nbsp/&nbsp</span><a class="nav-lang selected" href="#">EN</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">We offer everything to satisfy the most demanding needs!</h3>
                </div>
            </div>
            <?php
                $c = 0;
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">It looks like someone did a good job!</h3>
                </div>
            </div>
            <?php
                $c = 0;
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">We are profesionals, and we can prove it!</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <ul class="timeline">
                        <li>
                            ...
                            <div class="timeline-panel">
                                ...
                                <div class="timeline-body">
                                    <p class="text-muted">It all started out as a simple school project, but as it was developing we were recieving messages, so we decided to make it real!</p>
                                </div>
                            </div>
                        </li>
                        <li class="timeline-inverted">
                            ...
                            <div class="timeline-panel">
                                ...
                                <div class="timeline-body">
                                    <p class="text-muted">Our mission is to provide new and improved, high quality technologies tailored to the needs of our customers, with the primary objective of increasing profitability, competitiveness and productivity of the company.</p>
                                </div>
                            </div>
                        </li>
                        <!--
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">What would we do without them?</h3>
                </div>
            </div>
            <?php
                $c = 0;
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    ...
                    <h3 class="section-subheading text-muted">We will reply as soon as possible!</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <ul class="list-inline quicklinks">
                        <li><a target="_blank" href="../pdf/Aviso_de_Privacidad.pdf">Privacy Policy</a>
                        </li>
                        <li><a target="_blank" href="../pdf/Terminos_y_Condiciones_de_Uso.pdf">Terms of Use</a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-lg-offset-2">
                            <div class="modal-body">
                                ...
                                <p><a href="<?php echo $Row['URL']; ?>">See Project</a></p>
                                <ul class="list-inline">
                                    <li>Date: <?php echo $Row['Project_Date']; ?></li>
                                    <li>Client: <?php echo $Row['Company']; ?></li>
